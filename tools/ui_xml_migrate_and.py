#!/usr/bin/env python3
"""Replace UI bool AND operators with word 'and' in modern UI XML.

Rewrites `&amp;&amp;` and bare `&&` to `and` so attributes stay valid XML
and match UID_EvalBool word operators.
"""
